 ...
 * C source code generated on : Mon Aug 29 18:10:01 2022
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  real_T rtb_TmpSignalConversionAtToFile[9];
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Add = heli_q8_B.ElevationCounttorad - heli_q8_P.offset_elevation;
  }
   ...
   *  Step: '<Root>/Step'
   */
  u0 = heli_q8_M->Timing.t[0];
  if (u0 < heli_q8_P.Step1_Time) {
    tmp = heli_q8_P.Step1_Y0;
  } else {
    tmp = heli_q8_P.Step1_YFinal;
  }
   ...
   *  Step: '<Root>/Step'
   */
  if (tmp > heli_q8_P.Switch_Threshold) {
    /* Switch: '<Root>/Switch' incorporates:
     *  Constant: '<Root>/Constant2'
     */
    heli_q8_B.Switch = heli_q8_P.Constant2_Value;
  } else if (u0 < heli_q8_P.Step_Time) {
    /* Step: '<Root>/Step' incorporates:
     *  Switch: '<Root>/Switch'
     */
    heli_q8_B.Switch = heli_q8_P.Step_Y0;
  } else {
    /* Switch: '<Root>/Switch' incorporates:
     *  Step: '<Root>/Step'
     */
    heli_q8_B.Switch = heli_q8_P.Step_YFinal;
  }
   ...
   *  Sum: '<S5>/Subtract'
   */
  heli_q8_B.Subtract1 = (heli_q8_B.Switch - heli_q8_B.PitchCounttorad) *
    heli_q8_P.k_pp - heli_q8_P.k_pd * heli_q8_B.PitchTransferFcn;
   ...
   *  Sum: '<S6>/Sum'
   */
  heli_q8_B.Add_h = ((heli_q8_X.Integrator_CSTATE + heli_q8_B.K_ep) -
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_B.Add;
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_B.ElevationTransferFcn;
    rtb_TmpSignalConversionAtToFile[6] = heli_q8_B.Switch;
    rtb_TmpSignalConversionAtToFile[7] = heli_q8_B.Subtract1;
    rtb_TmpSignalConversionAtToFile[8] = heli_q8_B.Add_h;
      ...
      if (rtmIsMajorTimeStep(heli_q8_M) ) {
        {
          if (!(++heli_q8_DW.ToFile1_IWORK.Decimation % 1) &&
              (heli_q8_DW.ToFile1_IWORK.Count * (9 + 1)) + 1 < 100000000 ) {
            ...
            if (fp != (NULL)) {
              ...
              if (((++heli_q8_DW.ToFile1_IWORK.Count) * (9 + 1))+1 >= 100000000)
              {
                (void)fprintf(stdout,
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Add_h - heli_q8_B.Subtract1) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Add_h + heli_q8_B.Subtract1) * heli_q8_P.Backgain_Gain;
...
void heli_q8_initialize(void)
{
  ...
  /* Start for ToFile: '<Root>/To File1' */
  {
    ...
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M, "Error creating .mat file Variables.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp, 9 + 1, 0, "variables")) {
      rtmSetErrorStatus(heli_q8_M,
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      char fileName[509] = "Variables.mat";
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M, "Error closing MAT-file Variables.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M, "Error reopening MAT-file Variables.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 9 + 1, heli_q8_DW.ToFile1_IWORK.Count,
           "variables")) {
        rtmSetErrorStatus(heli_q8_M,
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (954412935U);
  heli_q8_M->Sizes.checksums[1] = (1397456989U);
  heli_q8_M->Sizes.checksums[2] = (2076779867U);
  heli_q8_M->Sizes.checksums[3] = (2437302059U);
