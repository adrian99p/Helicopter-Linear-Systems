...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&heli_q8_P.Joystick_gain_x), 0, 0, 6 },

  { (char_T *)(&heli_q8_P.HILWriteAnalog_channels[0]), 7, 0, 2 },

  { (char_T *)(&heli_q8_P.HILInitialize_OOTerminate), 0, 0, 58 },
